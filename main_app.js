...
const CONST_WHATSAPP_NUMBER = "542215713693"; 
...
class PizzeriaApp {
    ...
    renderMenu(items) {
        ...
        items.forEach(item => {
            ...
            if (item['SUCURSAL 1'] && this.normalize(item['SUCURSAL 1']) === 'NO') return;
            ...
            if (cleanSection === 'CONFIGURACION') {
                ...
                if (this.normalize(item.NOMBRE) === 'ALIAS') {
